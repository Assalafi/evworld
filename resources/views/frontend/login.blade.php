					...
					<div class="register">
						...
						<form class="form" method="POST" action="{{ route('frontend.customer-login') }}">
							...
							<div class="form-group">
								<input name="email" type="email" class="form-control @error('email') is-invalid @enderror" placeholder="{{ __('Email Address') }}" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                @if ($errors->has('email'))
