	...
	<div class="cart-sidebar">
		...
		<div class="cart-footer">
            ...
            onclick="
                ...
                if (this.innerHTML.trim() === '{{ __('Buy Now') }}') {
                this.innerHTML = phoneNumber;
                this.href = 'tel:' + intlNumber;
                } else {
	...
	<div class="whatsapp-{{ $gtext['position'] }}">
		<a href="https://wa.me/{{ $gtext['whatsapp_id'] }}/?text={{ $gtext['whatsapp_text'] }}" target="_blank" class="whatsapp-btn">
