									...
									<div class="row">
										<div class="col-md-12">
											<div class="mb-3">
												...
												<input id="name" name="name" type="text" class="form-control" placeholder="{{ __('Name') }}" value="@if(isset(Auth::user()->name)) {{ Auth::user()->name }} @endif" required autocomplete="name" autofocus="">
												@if ($errors->has('name'))
									...
									<div class="row">
										<div class="col-md-12">
											<div class="mb-3">
												...
												<input id="email" name="email" type="email" class="form-control" placeholder="{{ __('Email Address') }}" value="@if(isset(Auth::user()->email)) {{ Auth::user()->email }} @endif" required autocomplete="email" readonly>
												@if ($errors->has('email'))
