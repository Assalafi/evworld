		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12 col-md-12 col-lg-4 col-xl-4 col-xxl-4">
					...
					<div class="banner-item mb25">
						<div class="banner-item-img">
							<img src="{{ asset('public/media/'.$position_1['image']) }}"/>
						</div>
					...
					<div class="banner-item mb25">
						<div class="banner-item-img">
							<img src="{{ asset('public/media/'.$position_2['image']) }}"/>
						</div>
						<div class="banner-item-info">
				...
				<div class="col-sm-12 col-md-12 col-lg-4 col-xl-4 col-xxl-4">
					<div class="banner-item mb25">
						<div class="banner-item-img">
							<img src="{{ asset('public/media/'.$position_3['image']) }}"/>
						</div>
						<div class="banner-item-info">
				...
				<div class="col-sm-12 col-md-12 col-lg-4 col-xl-4 col-xxl-4">
					...
					<div class="banner-item mb25">
						<div class="banner-item-img">
							<img src="{{ asset('public/media/'.$position_4['image']) }}"/>
						</div>
						<div class="banner-item-info">
					...
					<div class="banner-item mb25">
						<div class="banner-item-img">
							<img src="{{ asset('public/media/'.$position_5['image']) }}"/>
						</div>
						<div class="banner-item-info">
				...
				<div class="col-lg-12">
					<div class="item-card mb30">
						<div class="item-image">
							...
							@endif
							<a href="{{ route('frontend.product', [$row->id, $row->slug]) }}"><img src="{{ asset('public/media/'.$row->f_thumbnail) }}" alt=""/></a>
						</div>
						<h4 class="item-title"><a href="{{ route('frontend.product', [$row->id, $row->slug]) }}">{{ str_limit($row->title) }}</a></h4>
						<div class="brand"><a href="{{ route('frontend.brand', [$row->brand_id, str_slug($row->brandname)]) }}">{{ str_limit($row->brandname) }}</a></div>
						<div class="item-price-card">
							@if($row->sale_price != '')
								@if($gtext['currency_position'] == 'left')
								<div class="item-price">{{ $gtext['currency_icon'] }}{{ $row->sale_price }}</div>
								@else
								<div class="item-price">{{ $row->sale_price }}{{ $gtext['currency_icon'] }}</div>
								@endif
							@endif
							@if($row->old_price != '')
								@if($gtext['currency_position'] == 'left')
								<div class="old-item-price">{{ $gtext['currency_icon'] }}{{ $row->old_price }}</div>
								@else
								<div class="old-item-price">{{ $row->old_price }}{{ $gtext['currency_icon'] }}</div>
								@endif
							@endif
						</div>
					</div>
