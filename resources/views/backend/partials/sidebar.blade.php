<div class="sidebar-wrapper">
	...
	<ul class="left-navbar">
		...
		<li><a href="{{ route('backend.orders') }}"><i class="fa fa-rocket"></i>{{ __('Orders') }}</a></li>
		<li><a href="{{ route('backend.transactions') }}"><i class="fa fa-credit-card"></i>{{ __('Transactions') }}</a></li>
		...
		<li class="dropdown"><a class="nav-link has-dropdown" href="#" data-toggle="dropdown"><i class="fa fa-paper-plane"></i>{{ __('Newsletters') }}</a>
			<ul class="dropdown-menu">
				...
				<li><a href="{{ route('backend.subscribe-popup') }}">{{ __('Subscribe Popup') }}</a></li>
