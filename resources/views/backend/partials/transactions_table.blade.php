	...
	<table class="table table-borderless table-theme" style="width:100%;">
		<thead>
			<tr>
				...
				<th class="text-left" style="width:15%">{{ __('Transaction#') }}</th>
				<th class="text-left" style="width:10%">{{ __('Order Date') }}</th>
				<th class="text-left" style="width:20%">{{ __('Customer') }} </th>
				<th class="text-left" style="width:10%">{{ __('Amount') }}</th>
				<th class="text-center" style="width:15%">{{ __('Payment Method') }}</th>
