...
class OrdersController extends Controller
{
    ...
    public function getOrderData($id) {
		...
		$mdata = DB::table('order_masters')
			...
			->join('payment_status', 'order_masters.payment_status_id', '=', 'payment_status.id')
			->join('order_status', 'order_masters.order_status_id', '=', 'order_status.id')
			->select('order_masters.*', 'users.name', 'payment_method.method_name', 'payment_status.pstatus_name', 'order_status.ostatus_name', 'order_masters.name as customer_name', 'order_masters.email as customer_email', 'order_masters.phone as customer_phone', 'order_masters.address as customer_address')
	...
	public function updateOrderStatus(Request $request){
		...
		if($payment_status_id == 1){
			$transaction_no = 'TXN-'.date("y").time();
			$data = array(
