...
class ProductsController extends Controller
{
    ...
    public function getProductsPageLoad() {
		...
		$datalist = DB::table('products')
			...
			->leftJoin('pro_categories', 'products.cat_id', '=', 'pro_categories.id')
        ...
        return view('backend.products', compact('AllCount', 'PublishedCount', 'DraftCount', 'languageslist', 'categorylist', 'brandlist', 'collectionlist', 'datalist'));
	}
    ...
    public function getProductPageData($id){
		...
		$languageslist = DB::table('languages')->orderBy('id', 'asc')->get();
        ...
        return view('backend.product', compact('datalist', 'statuslist', 'languageslist', 'brandlist', 'categorylist', 'collectionlist', 'labellist', 'taxlist', 'media_datalist'));
    }
    ...
    public function updateProductsData(Request $request){
        ...
        // get battery, range, charging and mileage
