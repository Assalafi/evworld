...
class ProductController extends Controller
{
    ...
    public function getProductPage($id, $title){
		...
		$data = DB::table('products')
			...
			->select('products.*', 'labels.title as labelname', 'labels.color as labelcolor', 'brands.name as brandname', 'pro_categories.name as cat_name', 'pro_categories.slug as cat_slug')
		...
		$related_products = DB::table('products')
			...
			->select('products.*', 'labels.title as labelname', 'labels.color as labelcolor', 'brands.name as brandname')
			->where('products.is_publish', '=', 1)
