...
//My Dashboard
Route::get('/user/my-dashboard', [App\Http\Controllers\Frontend\MyDashboardController::class, 'LoadMyDashboard'])->name('frontend.my-dashboard');
Route::get('/user/my-orders', [App\Http\Controllers\Frontend\MyDashboardController::class, 'LoadMyOrders'])->name('frontend.my-orders');
Route::get('/user/my-profile', [App\Http\Controllers\Frontend\MyDashboardController::class, 'LoadMyProfile'])->name('frontend.my-profile');
Route::post('/user/UpdateProfile', [App\Http\Controllers\Frontend\MyDashboardController::class, 'UpdateProfile'])->name('frontend.UpdateProfile');
Route::get('/user/change-password', [App\Http\Controllers\Frontend\MyDashboardController::class, 'LoadChangePassword'])->name('frontend.change-password');
Route::post('/user/ChangePassword', [App\Http\Controllers\Frontend\MyDashboardController::class, 'ChangePassword'])->name('frontend.ChangePassword');
...
Route::prefix('backend')->group(function(){
	...
	//Newsletters
	Route::get('/subscribe-popup', [App\Http\Controllers\Backend\NewslettersController::class, 'getSubscribePopup'])->name('backend.subscribe-popup')->middleware(['auth','is_admin']);
